...
//Ejemplo: Dado un vector de N numeros enteros encontrar el mayor valor y el menor valor del mismo.
...
echo "<br>El mayor es: " . mayor($V);
echo "<br>El menor es: " . menorSort($V);        
